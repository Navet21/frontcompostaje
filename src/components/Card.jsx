...
import { IoIosSchool} from "react-icons/io";
    ...
    return (
        <div
        className="flex flex-col sm:flex-row gap-4 justify-between items-center p-6 bg-gradient-to-br from-green-400 to-green-100 dark:from-gray-900 dark:to-dark-highlight rounded-lg shadow-lg hover:shadow-xl mb-4"
        >
